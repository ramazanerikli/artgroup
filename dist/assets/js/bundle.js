...
/* harmony import */ var _fortawesome_fontawesome_free_css_fontawesome_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @fortawesome/fontawesome-free/css/fontawesome.css */ "./node_modules/@fortawesome/fontawesome-free/css/fontawesome.css");
...
window.$ = window.jQuery = jquery__WEBPACK_IMPORTED_MODULE_7___default.a;

jquery__WEBPACK_IMPORTED_MODULE_7___default()('.slider').slick({
  dots: false,
  infinite: true,
  speed: 300,
  slidesToShow: 4,
...
detectResize(); // Call detectResize function when resize screen

window.onresize = detectResize; // Show warning message

sendBtn.onclick = function () {
  var checked_choice = document.querySelector('input[name = "choice"]:checked');
